...
Object* createVAOwithObj_forElementBuffer(const char* objFilePath) {
    assert(objFilePath != NULL);
    ...
    glBufferData(GL_ELEMENT_ARRAY_BUFFER, indSize*sizeof(int), indices, GL_DYNAMIC_DRAW);
    // glVertexAttribPointer(3, 3, GL_INT, GL_FALSE, 3 * sizeof(int), 0);
